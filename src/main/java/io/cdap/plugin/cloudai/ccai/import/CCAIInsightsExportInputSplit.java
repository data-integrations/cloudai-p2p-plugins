...
public final class CCAIInsightsInputSplit  extends InputSplit implements Writable {
  private long start = 0L;
  private long end = 0L;

  public CCAIInsightsInputSplit() {
  }

  public CCAIInsightsInputSplit(long start, long end) {
    this.start = start;
    this.end = end;
  }
