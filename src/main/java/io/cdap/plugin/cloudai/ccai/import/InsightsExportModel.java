...
final class InsightsModel {
  private static final Logger LOG = LoggerFactory.getLogger(InsightsModel.class);
  ...
  public static Schema getExportSchema() {
    ...
    fields.add(Field.of(SILENCE_PERCENTAGE, Schema.of(Schema.Type.DOUBLE)));
    fields.add(Field.of(AGENT_SPEAKING_PERCENTAGE, Schema.of(Schema.Type.DOUBLE)));
    fields.add(Field.of(CLIENT_SPEAKING_PERCENTAGE, Schema.of(Schema.Type.DOUBLE)));
    fields.add(Field.of(AGENT_SENTIMENT_SCORE, Schema.of(Schema.Type.DOUBLE)));
    fields.add(Field.of(AGENT_SENTIMENT_MAGNITUDE, Schema.of(Schema.Type.DOUBLE)));
    fields.add(Field.of(CLIENT_SENTIMENT_SCORE, Schema.of(Schema.Type.DOUBLE)));
    fields.add(Field.of(CLIENT_SENTIMENT_MAGNITUDE, Schema.of(Schema.Type.DOUBLE)));
  ...
  public static Schema getEntitySchema() {
    ...
    entityFields.add(Field.of(SENTIMENT_SCORE, Schema.of(Schema.Type.DOUBLE)));
    entityFields.add(Field.of(SENTIMENT_MAGNITUDE, Schema.of(Schema.Type.DOUBLE)));
    entityFields.add(Field.of(SALIENCE, Schema.of(Schema.Type.DOUBLE)));
  ...
  public static Schema getSentenceSchema() {
    ...
    sentenceFields.add(Field.of(SENTIMENT_SCORE, Schema.of(Schema.Type.DOUBLE)));
    sentenceFields.add(Field.of(SENTIMENT_MAGNITUDE, Schema.of(Schema.Type.DOUBLE)));
  ...
  public static StructuredRecord createExportRecord(
    ...
    StructuredRecord.Builder record = StructuredRecord.builder(InsightsModel.getExportSchema());
    ...
    record.set(SILENCE_PERCENTAGE, 0.0);
    record.set(AGENT_SPEAKING_PERCENTAGE, 0.0);
    record.set(CLIENT_SPEAKING_PERCENTAGE, 0.0);
    record.set(AGENT_SENTIMENT_SCORE, 0);
    record.set(AGENT_SENTIMENT_MAGNITUDE, 0);
    record.set(CLIENT_SENTIMENT_SCORE, 0);
    record.set(CLIENT_SENTIMENT_MAGNITUDE, 0);
