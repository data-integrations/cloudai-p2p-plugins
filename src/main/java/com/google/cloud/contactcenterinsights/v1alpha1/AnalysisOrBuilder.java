...
public interface AnalysisOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.contactcenterinsights.v1alpha1.Analysis)
   ...
   */
  com.google.cloud.contactcenterinsights.v1alpha1.AnalysisResult getAnalysisResult();
  /**
   * <pre>
   * Output only. The result of the analysis, which is populated when the analysis
   * finishes.
   ...
   * <code>.google.cloud.contactcenterinsights.v1alpha1.AnalysisResult analysis_result = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.contactcenterinsights.v1alpha1.AnalysisResultOrBuilder getAnalysisResultOrBuilder();
}
